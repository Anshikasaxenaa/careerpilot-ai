...
export default function LoginPage() {
  ...
  return (
    <div>
      ...
      <p className="text-slate-400 mb-8">Sign in to continue your prep journey</p>
      ...
      <div className="mt-6 text-center">
        ...
        <Link to="/register" className="text-brand-400 hover:text-brand-300 text-sm font-medium transition-colors">Create one free</Link>
      </div>
    </div>
  );
}
