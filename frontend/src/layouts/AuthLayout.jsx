      ...
      >
        ...
        >
          <div className="flex items-center gap-3 mb-12">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-brand-500 to-purple-500 flex items-center justify-center text-white font-bold text-xl shadow-lg shadow-brand-500/30">
              P
            </div>
            <span className="text-2xl font-bold text-white">PrepAI</span>
          </div>
          <h1 className="text-4xl font-bold text-white leading-tight mb-6">
            Land your <span className="gradient-text">dream job</span> with
            AI-powered prep
          </h1>
          <p className="text-slate-400 text-lg leading-relaxed mb-10">
            Master interviews with personalized AI feedback, real-time coding
            challenges, and intelligent performance analytics.
          </p>
          {[
